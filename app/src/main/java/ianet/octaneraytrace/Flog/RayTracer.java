package ianet.octaneraytace_2.Flog;
...
public class RayTracer {
    ...
    public class Color {
        ...
        public Color addScalar(Color c1, double s) {
        ...
        public Color multiplyScalar(Color c1, double f) {
        ...
        public Color blend(Color c1, Color c2, double w) {
    ...
    // NB JS original allowed for undefined parameters. Using NaN as the logical equivalent for doubles
    ...
    public class Light {
        ...
        public Light(Vector pos, Color color, double intensity) {
            this.position = pos;
            this.color = color;
            this.intensity = Double.isNaN(intensity) ? 10.0 : intensity;
        }
    ...
    public class Vector {
        ...
        public Vector function (Vector v, Vector w) {
        ...
        public Vector multiplyScalar(Vector v, double w) {
